...
#endif
static const char *ng0 = "E:/software_data/ISE_data/P6_all/P6_madd/EXT.v";
...
LAB46:    t155 = (t50 + 4);
    t156 = *((unsigned int *)t50);
    t157 = *((unsigned int *)t155);
    t158 = (t156 || t157);
    if (t158 > 0)
        goto LAB47;

LAB48:    t171 = *((unsigned int *)t50);
    t172 = (~(t171));
...
LAB47:    t161 = (t0 + 1048U);
    ...
    *((unsigned int *)t161) = (t169 & 65535U);
    t170 = ((char*)((ng3)));
    xsi_vlogtype_concat(t159, 32, 32, 2U, t170, 16, t160, 16);
    goto LAB48;
...
LAB89:    memcpy(t175, t301, 8);

LAB90:    goto LAB50;

LAB51:    xsi_vlog_unsigned_bit_combine(t49, 32, t159, 32, t175, 32);
    goto LAB55;

LAB53:    memcpy(t49, t159, 8);
    goto LAB55;
...
LAB92:    *((unsigned int *)t305) = 1;

LAB94:    memset(t302, 0, 8);
    t321 = (t305 + 4);
...
LAB104:    if (*((unsigned int *)t302) > 0)
        goto LAB105;

LAB106:    memcpy(t301, t348, 8);

LAB107:    goto LAB85;

LAB86:    xsi_vlog_unsigned_bit_combine(t175, 32, t285, 32, t301, 32);
    goto LAB90;
...
LAB99:    t333 = ((char*)((ng1)));
    ...
    *((unsigned int *)t335) = (t343 & 65535U);
    xsi_vlogtype_concat(t332, 32, 32, 2U, t334, 16, t333, 16);
    goto LAB100;

LAB101:    t348 = ((char*)((ng1)));
    goto LAB102;

LAB103:    xsi_vlog_unsigned_bit_combine(t301, 32, t332, 32, t348, 32);
    goto LAB107;

LAB105:    memcpy(t301, t332, 8);
    goto LAB107;

}


extern void work_m_00000000003678657892_1785967555_init()
{
	static char *pe[] = {(void *)Cont_12_0};
	xsi_register_didat("work_m_00000000003678657892_1785967555", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000003678657892_1785967555.didat");
